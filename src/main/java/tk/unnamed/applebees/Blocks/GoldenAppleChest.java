...
public class GoldenAppleChest extends BlockContainer implements ITileEntityProvider {
	
	private final Random random = new Random();
	
	public GoldenAppleChest() {
		super(Material.wood);
		this.setBlockName("golden_apple_chest");
		this.setBlockTextureName(AppleBees.MODID + ":" + "golden_apple_chest");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int q, float a, float b, float c) {
		if(!world.isRemote && !player.isSneaking()) {
			player.openGui(AppleBees.instance, BlockManager.guiIDGoldenAppleChest, world, x, y, z);
			return true;
		} else {
			return false;
		}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityGoldenAppleChest();
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int metaData)
    {
        ...
        if(tileentitychest != null)
        {
            ...
            blockDrop = new EntityItem(world, x, y, z, new ItemStack(BlockManager.goldenAppleChest));
